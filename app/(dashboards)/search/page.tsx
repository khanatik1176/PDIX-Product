...
const getSortedNotes = (notes, sortBy, sortOrder) => {
  let sorted = [...notes];
  switch (sortBy) {
    case 'downloads':
...
const SearchPage = () => {
  ...
  const filteredNotes = useMemo(() => {
    let notes = DUMMY_NOTES.filter(note =>
  ...
  return (
    <div className="w-full px-4 md:px-6 xl:px-10 mt-6">
      {/* Top: Search and Filter side by side */}
      <div className="flex flex-col gap-4 mb-4 w-full md:flex-row md:items-center">
        {/* Search Bar */}
