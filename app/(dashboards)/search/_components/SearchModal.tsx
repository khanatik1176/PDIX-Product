...
import FeedBackSection from '../../home/_components/FeedBackSection';
import { useQuery } from '@tanstack/react-query';
import { fetchIndividualNote } from '@/helpers/Home/HomeApi';

const SearchModal: React.FC<NoteModalProps> = ({ open, onClose, note }) => {
  ...
  const {
    ...
    console.log('SearchModal Rendered with note:', individualNoteData);
